...
\begin{tabular}{|p{7cm}|p{9cm}|}
 \hline
 \textbf{Theory} & \textbf{Overview} \\ [0.5ex] 
 \hline
 The Delayed Oscillator \citep{Suarez:1988aa, Battisti:1988aa} & Considering the effects of equatorially trapped oceanic wave propagation. \\
 \hline
 The Recharge Oscillator \citep{Jin:1997aa} & Considering the buildup of warm water in the western Pacific as a precondition to the development of El Ni\~{n}o. \\
 \hline
\end{tabular}
\captionof{table}[ENSO Oscillators]{Various ENSO oscillator theories and their main differences from the Zebiak-Cane model.}
\label{table:enso_oscillators}
\end{center}
\end{table}

the delayed oscillator \citep{Suarez:1988aa, Battisti:1988aa}, the recharge oscillator \citep{Jin:1997aa}, the western Pacific oscillator \citep{Weisberg:1997aa, wang1999effects}, and the advective-reflective oscillator \citep{Picaut663}.\\
