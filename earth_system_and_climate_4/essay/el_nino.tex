...
These variants of Zebiak and Cane's work provides adjustments and improvements to the atmospheric and oceanic components of the ZC model, allowing for improvements in the accuracy and precision in the prediction of ENSO events. \\
