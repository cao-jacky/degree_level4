...
% Exploring individual theories may prove problematic as there is a general tendency for studies to explore different aspects of the ENSO phenomenon.  As of yet there is no one true ``grand unifying El Ni\~{n}o theory'' (GUENT), however the separate analyses may provide an indication of how a GUENT could be obtained.  \\
% words: 51

% Strong El Niños 
In \\
%The ideal starting place to understand El Ni\~{n}o would be at the basic descriptio
