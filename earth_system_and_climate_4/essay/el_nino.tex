...
Examinations of the autocorrelation, persistence, and phase locking of ENSO data sets provides one set of tools to help discern and identify the predictability barrier. \\
% words: 21
...
\cite{torrence1998annual} provides a potential hypothesis which proposes that persistence drops off in the boreal spring due to low signal-to-noise (S/N) of ENSO relative to the background. They argue that the low S/N is due to the strong phase locking of the ENSO to the annual cycle which results in transition time between ENSO events to happen in spring. This is further substantiated by \cite{levine2015annual}
