...
Through an analysis of the $\delta^{18}$O data it can be implied that that the Milankovitch-Croll hypothesis has some merit, however there are various issues which prevent the theory to be fully accepted. \\
