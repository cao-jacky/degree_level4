...
Employing this final equation with values for cluster redshifts $z$ and the deceleration parameter $q_0$, $H_0$ can be obtained in this direct alternative way which is independent of the chain of distance estimators. The SPT-SZ is an instrument which makes use of the SZE to detect galaxy clusters \citep{2009AIPC.1185..475C}. Multiple attempts have been made to constrain cosmological parameters using SPT-SZ datasets. In the work by \cite{2016ApJ...832...95D} \cite{2014ApJ...782...74H} \\
