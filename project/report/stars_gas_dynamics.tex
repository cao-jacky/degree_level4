...
Ellipticals were codified by E$n$, where $n$ represents the galaxy ellipticity calculated from $(a-b)/a$ in integer form. E0 would equate to non-elliptical galaxies and E7 would be galaxies with the largest ellipticities. 
