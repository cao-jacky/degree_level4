...
With the gas dynamics of galaxies represented through the width of the [OII] doublet, for a comparison to the galactic stars, one would need the widths of the stellar spectra features. To obtain these standard deviation values a Penalized Pixel-Fitting method (pPXF) can be applied, \cite{cappaellari_ppxf} describes the method and implementation in the form of a Python library.


It would be a reasonable initial assumption to consider the entirety of the spectrum past the [OII] feature. 
