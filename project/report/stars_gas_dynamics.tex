...
We must ask ourselves then what each grouping represents in relation to the make-up of the galaxy. Alongside the general classification from appearance we can also explore the component composition of the three types of galaxies. 

Take ellipticals, we can see from the Hubble Tuning Fork that they are spherical-like distributions of gas, dust, and dark matter. The stars within them are old red types, the star forming rate is low \cite{carroll_astro}. [say in section blah blah blah more will be discussed about star forming rates] 
