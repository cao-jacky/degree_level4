...
Amongst the different types of cosmic structure within our universe, galaxies can be described as the most unique and diverse. With an approximate [insert number here] galaxies in our universe, each of which containing countless numbers of stars, gas, dust, and dark matter \cite{carroll_astro}, it would be difficult not to express the statement that the motions of these objects must be linked together in some galactic relationship. 

% I'm not sure about this opening introduction, it just feels a bit weak. I need to have a strong opening to which I can discuss galaxies. Maybe give qualitative numbers and facts about galaxies e.g. number of galaxies in the universe, how many stars are in an average galaxy...etc 
...
% I'm just not a fan of the "as an example bit". As always, I want to tell a story. I want to be able to lift the section headings and still keep the story together in a narrative.
...
\begin{center}
\includegraphics[width=0.6\linewidth]{data/cube_1804_fitted}
\captionof{figure}[OII Luminosity vs. Redshift]{Fitting of a galaxy spectrum with pPXF.}
\label{fig:oiiluminosity_redshift}
\end{center}

\begin{center}
\includegraphics[width=0.6\linewidth]{data/reprocessed_sn_vs_delta_sigma}
