...
One can guarantee that any galaxy in the Universe contains gas and stars amongst other celestial objects. The dynamics of which can be explored by observing the galaxy using optical and spectroscopic data.
...
Amongst the different types of cosmic structure within our universe, galaxies can be seen as the island powerhouses of industry and activity. 
