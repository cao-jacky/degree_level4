...
\begin{figure}
\includegraphics[width=1.0\linewidth]{introduction/fritz_2009}
\caption{The total intrinsic specific angular momentum $j_*$ against total stellar mass $m_*$ for different galaxies (from \citealt{2012ApJS..203...17R}). Legend in upper left shows the galaxy types used. Ellipticals follow a similar relationship to spirals but with an offset of $\sim6$ to lower $j_*$. This diagram represents one of the scaling relations for galaxies which reflect their internal dynamics.}
\label{fig:faber_jackson}
\end{figure}

For ellipticals, \cite{1976ApJ...204..668F} produced a scaling relation between the luminosity and velocity dispersions. They chose the velocity dispersions as they quantify

\begin{figure}
\includegraphics[width=\linewidth]{introduction/reyes_2011}
\caption[Hubble Ultra Deep Field]{The total intrinsic specific angular momentum $j_*$ against total stellar mass $m_*$ for different galaxies (from \citealt{2012ApJS..203...17R}). Legend in upper left shows the galaxy types used. Ellipticals follow a similar relationship to spirals but with an offset of $\sim6$ to lower $j_*$. This diagram represents one of the scaling relations for galaxies which reflect their internal dynamics.}
\label{fig:tully_fisher}
\end{figure}

On the other hand, \cite{1977A&A....54..661T} derived a relation between absolute magnitude and H$\alpha$ emission line width for spiral galaxies. Alternatively, the relationship can be re-expressed to couple the stellar mass and rotational velocity of a galaxy, Figure \ref{fig:tully_fisher} demonstrates that there is a consistent relationship between these two parameters. \cite{2011MNRAS.417.2347R} calibrated several Tully--Fisher models to consider the contributions from galactic discs, stars, and dark matter. Through these calibrations, the Tully--Fisher relation could be applied to the construction of galaxy formation and evolution models.



% okay, Tully-Fisher, it's a scaling relation, I've told what it's a relationship between and that's it I guess - in terms of stating what the relationship is, and providing an example through plots. I need to emphasis these scaling relations and how they are defined using local galaxies

Figure \ref{fig:tf_fj_relations} provides examples of both the Tully--Fisher and Faber--Jackson

% TF and FB relations are the two most notable scaling relations
