...
Subsequent identification schemes would build and refine Hubble's sequence as a result of analysing larger datasets which included more distant extra-galactic objects. The work undertaken in \cite{1961hag..book.....S, 1975gaun.book....1S} and  \cite{1994cag..book.....S} would result in lenticulars (S0) to be included as a fourth grouping, these galaxies contain a central bulge and feature a disk but contain no visible spiral structure. \cite{1959HDP....53..275D} on the other hand would redefine the spiral category and argued for the importance of rings and lenses as their characteristic defining features. 

Whilst these modifications provide an extended classification of galaxies through their morphologies, it would be beneficial to employ fundamental parameters which are related to the inner content within a galaxy.
...
The mass, energy, and angular momentum are three physical values which can be used to classify and quantify a galaxy. Their use can be  

Through observations of galaxies and their morphologies, their dynamics can be quantified and expressed into fundamental parameters such as mass, energy, and angular momentum. 


\cite{1980MNRAS.193..189F} and \cite{1998MNRAS.295..319M} provide a picture on the formation and evolution of spiral galaxies by employing rotational mechanics within simple cosmological models. Fall and Efstathiou discuss the effects of variables such as the gas angular velocity and the length-velocity scales of the tidal torque turbulence on the total angular momentum per unit mass within the protogalactic disk and halo. Mo et al.~builds a simple model which employs cosmological parameters and assumes that the mass and angular momentum for the disk are fixed fractions of the surrounding dark halo. 
