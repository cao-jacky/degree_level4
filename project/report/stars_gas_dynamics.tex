...
Through contentious debate and research, astronomers can continue to build these different models and theories which attempt to explain galactic evolution. However, to prove or disprove any amount of them, observational data will definitely be required. 

% Give the power-law form of the IMF?
% What can be linked to the above discussion about galactic stellar formation?
% talk about masses and then luminosities and then observations using telescopes and instruments - that will lead nicely into the next section
...
% maybe give some information on how stars actually form and the classification of stars as well? OBAFGKM?
