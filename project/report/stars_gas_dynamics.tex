...
In addition to optical observations, to truly study the HUDF objects, spectroscopic data must also be collected. One particular instrument which has been employed to acquire data on the HUDF region is the Multi-Unit Spectroscopic Explorer (MUSE) mounted to the Nasmyth platform on the Very Large Telescope (VLT) \cite{bacon_muse_proposal}.
