...
The Hubble Space Telescope (HST) has been operating since April 1990 and for the duration of that time it has collected over 50 terabytes of data \cite{mccoy_space_sciences}. From observing nebulae to attempts to detect extra-solar planets, the HST has been employed in a variety of searches. However, one of the most impressive and insightful uses of HST was the collection of the long-exposures taken in 1996. 

Through a combination of its visible and infrared cameras, the Hubble Deep Field (HDF) was produced \cite{mccoy_space_sciences, williams_hdp}. The image was formed by piecing together several different exposures to create the final frame. It contained over 10,000 different galaxies, and taken from an area of just 

\subsubsection{MUSE}

To obtain spectroscopic information on the HUDF objects, the Multi-Unit Spectroscopic Explorer or MUSE was employed. This instrument is 
...
The key goal in the analysis was to reduce down individual galaxy spectra to then apply fitters which would provide us with a way to compare the stars in a galaxy to the gas within it. 
