...
The Hubble sequence classifies galaxies into three general groupings of elliptical, spiral, and irregular galaxies. As demonstrated by Hubble 1926 [CITATION HERE], a population of 400 z=0 extra-galactic objects can be classified and sorted through studying their morphological natures. Ellipticals are codified by their ellipticity starting from non-elliptical E0 and running in integer steps until high ellipticity E7. Spiral galaxies have ellipticities greater than E7 and are classified by their structures. 
