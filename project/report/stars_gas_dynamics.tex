...
In Section \ref{sec:analysis}, the methodology of the galaxy extraction from the MUSE cube is discussed, as well as the subsequent analysis performed by applying different fitting routines: [OII] Gaussian doublet fittings, Voigt profile fittings, and fitting with a penalised pixel-fitting method (pPXF). 
...
After extracting the individual galactic objects from the MUSE cube, the spectroscopic data could then be manipulated and analysed using different fitting routines: (i) [OII] doublet fittings, (ii) pPXF absorption and emission line fittings, and (iii) Voigt profile fittings.  
