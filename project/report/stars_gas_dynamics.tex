...
Amongst the different types of cosmic structure within our universe, galaxies can be described as the most unique and diverse. With potentially $\sim$ ($2.0^{+0.7}_{-0.6}$) $\times 10^{12}$ galaxies in the universe up to $z=8$  which could in principally be observed \cite{conselice_galaxynumber}, each of which containing countless numbers of stars, gas, dust, and dark matter \cite{carroll_astro}, it would be difficult not to express the statement that the motions of these objects must be linked together in some galactic relationship. 
