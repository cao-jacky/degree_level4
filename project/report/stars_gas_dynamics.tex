...
The mass, energy, and angular momentum are three physical values which can be alternatively used to classify and quantify a galaxy. They provide a quantitative description which reflects the internal makeup of the galaxy. 

The angular momentum is of particular interest as that indicates the current motions
