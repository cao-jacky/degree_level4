...
Quantifying the dynamics of a galaxy can be achieved using several parameters, one of which is the angular momentum contained within them. 

The angular momentum acquired by \cite{1980MNRAS.193..189F}

One method The dynamics of a galaxy can be quantified 

Through studies of the gas and stellar makeup of galaxies one can obtain relations which describe various aspects of galactic evolution.

 for example the time scale of the evolution \citep{1963ARA&A...1..149R}, 
