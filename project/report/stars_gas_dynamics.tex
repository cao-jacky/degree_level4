...
Whilst these modifications provide a clearer understanding on how galaxies can be codified together, they do not provide a comprehensive explanation for the mechanics of individual galaxies. 
...
Through observations of galaxies and their morphologies, their dynamics can be quantified and expressed into various relationships. \cite{1980MNRAS.193..189F} provided a picture on the formation and later evolution of spiral galaxies by means of rotational mechanics. Within a protogalactic system, an analysis of the initial conditions such as the gas angular velocity and the length-velocity scales of the tidal torque turbulence yields values for the total angular momentum per unit mass within the galaxy disk and halo,
\begin{equation}
J_D/M_D = J_H/M_H.
\end{equation}

\cite{1998MNRAS.295..319M} subsequently built upon the theory for spiral disk formation by building a simple cosmological model which assumed that the mass and angular momentum for the disk are fixed fractions of the surrounding dark halo. Through 
