...
def data_obtainer(cube_id):
    ...
    print("C"+str(cube_id) + " & " + str(curr_raf_id) + " & " + str(curr_ra) + " & " + 
            str(curr_dec) + " & $" + str(curr_f606) + "\pm" + str(curr_f606_err) + 
            "$ & $" + str(curr_z) + "\pm" + str(curr_z_err) + "$ & $" + str(vel_stars) 
            + "\pm" + str(vel_stars_err) + "$ & $" + str(sigma_stars) + "\pm" + 
            str(sigma_stars_err) + "$ & $" + str(vel_oii) + "\pm" + str(vel_oii_err) +
            "$ & $ " + str(sigma_oii) + "\pm" + str(sigma_oii_err) + "$ \^ \n")
