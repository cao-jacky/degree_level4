...
def analysis_complete(data_dir, stk_f_n, gss_result, init_pms, opti_pms, 
    ...
    data_file.write("'sigma_gal': " + str(init_pms['sigma_gal'])  + "\n")
    data_file.write("'z': " + str(init_pms['z'])  + "\n\n")
    data_file.write("'sigma_inst': " + str(init_pms['sigma_inst'])  + "\n")
    ...
    data_file.write("'sigma_gal': " + str(opti_pms['sigma_gal'])  + "\n")
    data_file.write("'z': " + str(opti_pms['z'])  + "\n\n")
    data_file.write("'sigma_inst': " + str(opti_pms['sigma_inst'])  + "\n")
